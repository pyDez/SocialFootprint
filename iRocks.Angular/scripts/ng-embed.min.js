                ...
                link: function (scope, elements, attributes) {
                    ...
                    var videoProcess = {
                        ...
                        embedBasic: function (data) {
                            ...
                            if (data.match(f)) {
                                scope.video.basic = $sce.trustAsResourceUrl(data);
                            }
                            else {
                                scope.video.isFlash = true;
                                scope.video.src = $sce.trustAsResourceUrl(data);
                            }
                    ...
                    var begin = x.indexOf(autoplayString);
                    var tmp = ""
                    if (begin > -1) {
                        tmp = x.slice(0, begin + autoplayString.length - 1);
                        tmp += "0";
                        tmp += x.slice(begin + autoplayString.length, x.length);
                        x = tmp;
                    }
